  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script src="../controllers/typingtest.js" defer="defer"></script>
      </head>
      <body>
  ...
  <xsl:template match="typing_test">
    <div class="test-info">
      ...
      <div class="test-summary">
        <p><strong>Language:</strong> <xsl:value-of select="info/name" /> (<xsl:value-of select="info/type" />)</p>
    ...
    <xsl:if test="details">
      <div class="test-details-container">
        <div class="progress-graph">
          ...
          <div class="graph-container" id="progress-graph">
            <!-- JavaScript will dynamically render the graph here -->
